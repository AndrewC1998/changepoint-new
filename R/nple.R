...
nple <- function(data, penalty = "Manual", pen.value = 6 * log(length(data) - 16), method = "PELT", class = TRUE, minseglen = 30, nquantiles = 10, crop = 16, family = "DaubExPhase", filter.number = 10, binwidth = 1){
